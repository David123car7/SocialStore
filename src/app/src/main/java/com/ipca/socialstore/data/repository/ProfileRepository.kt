...
class ProfileRepository @Inject constructor(
    ...
    suspend fun createProfile(profile: ProfileModel): ResultWrapper<Int>{
        return try {
            ...
            if(profile == null) return ResultWrapper.Error(AppError.ErroCreatingTable(R.string.table_profile))
            if(profile.id == null) return ResultWrapper.Error(AppError.UnknownError("Database returned null ID"))
